...
https://github.com/PoC-Scavenger/scavenger/wiki

### Binary + source code releases

https://github.com/PoC-Scavenger/scavenger/releases
...
https://github.com/PoC-Scavenger/scavenger/blob/master/config.yaml
